...
public class Conta {
    ...
    public void fecharConta(){
        if (this.getSaldo() < 0){
            System.out.println("Impossível fechar a conta. Necessário pagar o débito restante.");
        } else if (this.getSaldo() > 0){
            System.out.println("Impossível fechar a conta. Necessário sacar o saldo restante.");
        } else {
