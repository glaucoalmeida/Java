 ...
 * @author jglau
 */
public class TeleSoma extends javax.swing.JFrame {

    /**
     * Creates new form TeleSoma
     */
    public TeleSoma() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeleSoma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
